...
#define TPTAG_CERTIFICATE_FILE_REF(x) tptag_certificate_file_ref, tag_str_v(&(x))
...
#define TPTAG_CERTIFICATE_PRIVATE_KEY_REF(x) tptag_certificate_private_key_ref, tag_str_v(&(x))
...
#define TPTAG_CERTIFICATE_CA_FILE_REF(x) tptag_certificate_ca_file_ref, tag_str_v(&(x))
